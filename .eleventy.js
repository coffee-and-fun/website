...
export default function (eleventyConfig) {
  ...
  const tagMap = {
    ...
    ul: 'list-disc list-inside mt-4 space-y-2 pl-6 text-lg font-display ml-6 mb-8 text-gray-900',
    ol: 'list-decimal list-inside mt-4 space-y-2 pl-6 text-lg font-display ml-6 mb-8 text-gray-900',
    li: 'mb-2 text-lg font-display text-gray-900 flex items-center',
    ...
    a: 'text-lg text-blue-500 hover:text-blue-700 underline',
  ...
  eleventyConfig.addShortcode('bundledCss', () => manifest['main.css'] ? `<link href="${manifest['main.css']}" rel="stylesheet" />` : '');
  eleventyConfig.addShortcode('bundledJs', () => manifest['main.js'] ? `<script src="${manifest['main.js']}"></script>` : '');
