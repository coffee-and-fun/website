...
keywords:
  ...
  Coffee and Fun
url: blog/the-app-store-needs-higher-standards-too/
isBlog: true
blog_cat: Usecase
youtubeId:
cardTitle: The App Store Needs Higher Standards Too
blog_snip:
  Apple stopped $2.2B in fraud last year and Google Play deleted almost half its store. The
  walled gardens are still slipping, and here's what higher standards should actually mean.
name: Robert James Gabriel
img: /assets/images/blog/the-app-store-needs-higher-standards-too.png
...
A while back I wrote that [every major browser extension store needs higher standards](/blog/browser-extension-stores-need-higher-standards/). The response was bigger than I expected, and the most common reply was a version of the same question: *what about the app stores?* Aren't Apple and Google supposed to be the grown-ups in the room?
...
When people say app store review is "security theater," they haven't looked at the numbers. In 2025 alone, Apple says it [stopped more than $2.2 billion in fraudulent transactions](https://www.apple.com/newsroom/2026/05/the-app-store-stopped-over-2-point-2-billion-usd-in-fraudulent-transactions-in-2025/), part of more than $11.2 billion over the last six years. Its reviewers looked at over 9.1 million submissions and rejected more than 2 million of them. Over 371,000 were rejected specifically for being spam, copycats, or misleading. Another 443,000 were rejected for privacy violations. Apple terminated 193,000 developer accounts and blocked 1.1 billion fraudulent customer accounts.
...
If you want proof the bar was set too low for years, look at what Google just did. Between early 2024 and 2025, the Play Store [shrank by roughly 47%, from about 3.4 million apps down to 1.8 million](https://www.techspot.com/news/107745-google-play-shrinks-47-percent-following-policy-overhaul.html). Not because developers left, but because Google started enforcing a July 2024 policy overhaul and pulled apps with limited functionality, static content, and single-feature gimmicks.

Sit with that number. Google decided that **almost half of everything on its store shouldn't have been there.** In 2024 it blocked 2.36 million policy-violating apps and banned over 158,000 developer accounts. In 2025 it [used AI to help block another 1.75 million bad apps](https://www.engadget.com/apps/google-play-used-ai-to-help-block-175-million-bad-apps-in-2025-102208054.html) and banned 80,000 more developer accounts. Google's own [developer program policy](https://play.google/developer-content-policy/) now leans hard on "minimum functionality" and anti-spam language that simply wasn't enforced before.
...
Read my [browser extension post](/blog/browser-extension-stores-need-higher-standards/) and swap the nouns. The symptoms are identical. A low barrier to entry. A flood of AI-generated filler. Copycats riding trademarks and keywords. And badges, rankings, and "Editor's Choice" shelves that stop meaning anything once everything qualifies for them.

This is [the enshittification of technology](/blog/the-enshittification-of-technology/) playing out one storefront at a time. The platform launches with real curation, earns trust, then quietly lets the standard drift down while the marketing keeps saying "hand-picked." Users don't notice on day one. They notice after the fifth fake-free app in a row, when they stop trusting the charts entirely.
...
When we ship something we've actually sweated over, with real design, honest [pricing](/blog/how-to-price-your-app/), and a description written by a human who used the thing, we're standing in a line that also contains a hundred AI-generated wallpaper apps and a fleeceware clone of last month's hit. Every low-effort listing that gets in dilutes the trust of the whole store, and that trust is the only reason a stranger installs software from a studio they've never heard of.
...
If anyone at Apple or Google wants to talk about it, I'm easy to find: [hello@coffeeandfun.com](mailto:hello@coffeeandfun.com).
