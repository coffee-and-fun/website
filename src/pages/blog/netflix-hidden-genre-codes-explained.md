...
url: blog/netflix-hidden-genre-codes-explained/
isBlog: true
blog_cat: Tools
youtubeId:
...
The micro-genre system is a rare case where you can see a recommendation engine's raw material with your own eyes. Browsing the full list is oddly revealing: you realize Netflix doesn't think in "Comedy" and "Drama" at all. It thinks in "Understated Romantic Independent Movies." The homepage just flattens all of that nuance into whatever it predicts you'll click.

The codes give the nuance back. Put the aisle numbers in your pocket and go wander the parts of the store they don't put on display: [coffeeandfun.com/netflix](/netflix/).
