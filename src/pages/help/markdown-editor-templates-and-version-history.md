...
description: "Start from a README or meeting-notes template, and restore any earlier version of a document from automatic snapshots."
keywords: markdown templates, version history, restore document, snapshots, readme template, Coffee and Fun
url: help/markdown-editor-templates-and-version-history/
isHelp: true
product: markdown-editor
app: Markdown Editor
category: Writing tools
img: /assets/images/social/help/markdown-editor-templates-and-version-history.png
