...
title: "Install Markdown Editor & write your first note"
description: "Add Markdown Editor to your browser free, or get the $5 Apple app, and write your first document in under a minute."
keywords: install markdown editor, markdown editor chrome, markdown editor firefox, markdown editor safari, getting started, Coffee and Fun
url: help/markdown-editor-getting-started/
isHelp: true
product: markdown-editor
app: Markdown Editor
category: Getting started
img: /assets/images/social/help/markdown-editor-getting-started.png
...
- **In a browser:** click the Markdown Editor icon in your toolbar. The editor opens in its own tab.
- **On Apple devices:** open the Markdown Editor app like any other app.
...
- Press <kbd class="kbd kbd-sm">⌘</kbd> + <kbd class="kbd kbd-sm">/</kbd> anytime for the built-in markdown cheatsheet.
